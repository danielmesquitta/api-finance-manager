...
func (uc *SignInUseCase) updateUserAndSignIn(
	ctx context.Context,
...
func (uc *SignInUseCase) createUserAuthProvider(
	ctx context.Context,
	userID uuid.UUID,
	authProvider *entity.UserAuthProvider,
) error {
...
func (uc *SignInUseCase) updateUserAuthProvider(
	ctx context.Context,
