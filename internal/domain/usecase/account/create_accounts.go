...
type CreateAccountsUseCaseInput struct {
	ItemID          string                           `json:"id"              validate:"required"`
	Institution     CreateAccountsUseCaseInstitution `json:"connector"       validate:"required"`
...
type CreateAccountsUseCaseInstitution struct {
	ID int `json:"id" validate:"required"`
}

func (uc *CreateAccountsUseCase) Execute(
	ctx context.Context,
	in CreateAccountsUseCaseInput,
) error {
