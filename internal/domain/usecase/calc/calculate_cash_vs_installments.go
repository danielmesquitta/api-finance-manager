...
type CalculateCashVsInstallmentsUseCase struct {
	v  *validator.Validator
	ci *CalculateCompoundInterestUseCase
}

func NewCalculateCashVsInstallmentsUseCase(
	v *validator.Validator,
	ci *CalculateCompoundInterestUseCase,
) *CalculateCashVsInstallmentsUseCase {
	return &CalculateCashVsInstallmentsUseCase{
		v:  v,
		ci: ci,
	}
}

type CalculateCashVsInstallmentsUseCaseInput struct {
...
type CalculateCashVsInstallmentsUseCaseOutput struct {
...
func (uc *CalculateCashVsInstallmentsUseCase) Execute(
	ctx context.Context,
	in CalculateCashVsInstallmentsUseCaseInput,
) (*CalculateCashVsInstallmentsUseCaseOutput, error) {
	type Result struct {
		out *CalculateCashVsInstallmentsUseCaseOutput
		err error
	}
...
func (uc *CalculateCashVsInstallmentsUseCase) execute(
	...
	savingsWithCash, err := uc.ci.Execute(
		ctx,
