...
func NewStaging(v *validator.Validator, e *env.Env) *App {
	...
	generateAIChatMessageUseCase := aichat.NewGenerateAIChatMessageUseCase(v, pgxTX, openAI, aiChatRepo, aiChatMessageRepo, aiChatAnswerRepo, paymentMethodRepo, transactionCategoryRepo, institutionRepo, transactionRepo)
